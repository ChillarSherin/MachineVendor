...
// */
//public class Pay_Refund_NFC extends Activity {
//
...
//            db.updatesuccessRefund1(trans_id);
//            --RetryCount1;
//        }
//
//        while (count2 == 0 && RetryCount2 >= 0) {
//            db.updatePaymentRefund1(trans_id);
//            --RetryCount2;
//        }
//
//        if (RetryCount1 == 0 || RetryCount2 == 0) {
//

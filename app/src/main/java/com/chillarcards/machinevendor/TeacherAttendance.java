...
public class TeacherAttendance extends Activity implements View.OnKeyListener {
...
//    StringBuffer read_status = new StringBuffer();
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            for(Teacher_Details us: teacher){
                ...
                card_list.add(us.getCardSerial());
            ...
            transtype_id=db.getTransTypID("TEACHER ATTENDANCE");

            System.out.println("CODMOB: TEACHER ATTENDANCE ID  "+transtype_id);
...
//                                                    alert.dismiss();
//
//                                                    Intent i = new Intent(getApplicationContext(), com.chillarcards.machinevendor.TeacherAttendance.class);
//                                                    Bundle b=new Bundle();
////                                                    b.putString("id",attend_typ);
//                                                    b.putStringArrayList("card_list", card_list);
//                                                    i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
...
//                                                            }
//
//                                                            att_date=filler1+a_date;
//
//
//                                                            cardwrite(inout,att_date);
//
//                                                        } else if (in_out.equals("0000000000000001")) {
//                                                            filler4="";
//                                                            inout = "0000000000000000";
//                                                            a_date= getcurrentdatetime();
//                                                            System.out.println("ijaz   :   a_date   "+a_date);
//                                                            System.out.println("ijaz   :   a_date.length   "+a_date.length());
//                                                            int len3=16-a_date.length();
//                                                            System.out.println("ijaz   :   len3   "+len3);
//
//                                                            for(int j=0;j<len3;++j){
//
//                                                                filler4=filler4+"0";
//
//                                                                System.out.println("ijaz   :   filler4   "+filler4);
//
//                                                            }
//
//                                                            att_date=filler4+a_date;
//
//                                                            System.out.println("ijaz   :   att_date   "+att_date);
//                                                            System.out.println("ijaz   :   1016");
//                                                            cardwrite(inout,att_date);
//                                                        }
//                                                    }
//                                                    else
...
//                                                        }
//
//                                                        att_date=filler2+a_date;
//
//
//                                                        System.out.println("ijaz   :   1034");
//                                                        cardwrite(inout,att_date);
//
//                                                    }
////                                                }
...
//        private void cardwrite(String inout, String att_date)
//        {
//
////            a_type= at_type;
...
//            char[] attent_date = att_date.toCharArray();
//
//            System.out.println("ijaz :   inout1    "+inout1.toString());
//            System.out.println("ijaz :   inout1    "+inout.toString());
//            System.out.println("ijaz :   attent_date    "+attent_date.toString());
//            System.out.println("ijaz :   attent_date    "+att_date.toString());
//
//            authsuc1 = apis.tama_authenticate_mifare(TARGET_NUM,
//                    AUTH_FOURTH_SECT, key4, KEYA);
//
...
//        }
        ...
        private void Attendence() {
            ...
            System.out.println("ijaz   :  trans_id "+trans_id);
            System.out.println("ijaz   :  currentbalance "+currentbalance);
...
//        db.deleteAllAttendancedata();
            ...
            Attendance_Data attendancedata = new Attendance_Data(trans_id,userid,transtype_id,previousbalnce, currentbalance,resultCardSerial,
                    currentDateTimeString,"",Integer.parseInt(inout),trans_id,"");
            db.addSuccesstransaction(attendancedata);
            db.addTeacherAttendancedata(attendancedata);
...
//                        b.putString("id",attend_typ);
        ...
        public void alertbox1(String success, String msg){
            final AlertDialog.Builder dialog = new AlertDialog.Builder(TeacherAttendance.this);

...
public class CardInitialization extends Activity {
    ...
    /*
     * Every data we write into the card should be of length 16. So This fn converts data of small size into 16 digit long
     * */

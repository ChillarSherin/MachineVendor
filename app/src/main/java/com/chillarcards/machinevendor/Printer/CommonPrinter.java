...
import com.chillarcards.machinevendor.App;
...
public class CommonPrinter extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView mBillNO = findViewById(R.id.bill_no);
        ...
        mBillDate.setText("Bill Date : "+currentDateTimeString);
        mBillNO.setText("Bill No : "+billno);
...
//        finish();
    ...
    private void startServerUpload() throws UnsupportedEncodingException {
    ...
    private void PhpLoaderTest1(final List<Success_Transaction> successtransaction7, final int i) throws UnsupportedEncodingException {
        ...
        String URL=Constants.APP_URL+"c_successTransaction.php?" +
                ...
                "&transaction_id="+usp.gettrans_id()+
                "&card_serial="+usp.getcard_serial()+
                "&transaction_type_id="+usp.gettranstypeid()+
                "&current_balance="+usp.getcurrent_balance()+
                "&prev_balance="+usp.getprevious_balnce()+
                "&amount=" + total + //NEWELY ADDED
                "&time_stamp="+ URLEncoder.encode(usp.gettime_stamp(), "UTF-8") +
        ...
        System.out.println("Urlsuccesstransaction SERVER" + URL);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (server_respose.equals("success"))
                    {
                        ...
                        Toast.makeText(CommonPrinter.this, id, Toast.LENGTH_LONG).show();
                    }
                } catch (Exception e) {

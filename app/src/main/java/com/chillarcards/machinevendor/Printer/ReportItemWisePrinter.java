...
public class ReportItemWisePrinter extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Successprint= printbundle.getString("Print");
        total= printbundle.getString("tot_items");
...
//        total = Constants.TotalAmount;
        totalamtButton.setText("  Total Items Sold  :  "+total);
        printtext.setText(Successprint);
        ...
        printbill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String str =  "        "+schoolname+"\n"
                        + "              "+schoolplace+"\n"
                        + "           "+Constants.Category+" "+"REPORT ";
//                String str0 = "MC ID: "+
                String str1=  "     DATE " + formattedDate + " "
                        + "TIME " + times + "\n";
                String str2 = "     M/c CODE: "+machCode+" ";
                String str3 = "     ITEM                   QTY        \n--------------------------------------";
//                String str4 = Successprint;
                String str4 =	"" ;
                String str6 = Successprint+"\n";
                String str5 = "Total Items Sold  : " + total;
...
//                                || ret_str6 == -8|| ret_str5 == -8  || ret_str8 == -8) {
//
...
//                               || ret_str6 == -7  || ret_str5 == -8|| ret_str8 == -7) {
//
//                            Toast.makeText(getApplicationContext(),

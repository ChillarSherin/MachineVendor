...
import com.chillarcards.machinevendor.StudentCodeInitialisation;
 ...
 */
public class AdminRechargePrinter  extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_admin_recharge_printer);
        ...
        //getting values from recharge nfc using bundle
...
//                                    .show();
//
////                            Intent inte=new Intent(AdminRechargePrinter.this, AdminSettingsActivity.class);
...
//                ap.prn_paper_feed(5);
    ...
    public void onBackPressed() {
        ...
        Intent inte=new Intent(AdminRechargePrinter.this, StudentCodeInitialisation.class);
        inte.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(inte);
        finish();
    }

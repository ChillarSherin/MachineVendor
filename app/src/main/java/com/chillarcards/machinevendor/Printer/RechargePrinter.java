...
public class RechargePrinter extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_recharge_printer);
...
//
//
////                            Intent inte=new Intent(RechargePrinter.this, Payment_type_names.class);

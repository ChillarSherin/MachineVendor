...
public class TablesToUpdate extends Activity {

    Button success,payment,/*deviceinfo,blockcards,*/recharge,/*category,*/librarybook,attendence,fee,itemsale,/*itemStock,itemlist,
            userbutton,attendencetype,paymenttype,itemtype,transactiontype,*/report,online,parent_leave,refund;
    ...
    protected void onCreate(Bundle savedInstanceState) throws CursorIndexOutOfBoundsException {
        ...
        setContentView(R.layout.layout_tables_to_update);
...
//        category=(Button)findViewById(R.id.category);
        ...
        parent_leave= (Button) findViewById(R.id.parentLeave);
...
//        transactiontype= (Button) findViewById(R.id.transtype);
        ...
        online.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(db.getAllOnlineToUp().size()==0){
                    ...
                    Intent i = new Intent(getApplicationContext(), TablesToUpdateActivity.class);
                    Bundle b = new Bundle();
        ...
        parent_leave.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        success.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if(db.getAllsuccesstoup().size()==0 && db.getAllsxstoupNew().size()==0){
                    Toast.makeText(getApplicationContext(),"No Transactions in database!",Toast.LENGTH_SHORT).show();
                }else {
        ...
        payment.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(db.getAllpaytransactiontoUp().size()==0 && db.getAllpaytransactiontoUpNew().size()==0){
                    Toast.makeText(getApplicationContext(),"No Transactions in database!",Toast.LENGTH_SHORT).show();
                }else {
...
//        });
        ...
        refund.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getApplicationContext(),"No Refund Trans in database!",Toast.LENGTH_SHORT).show();
                }else {

                    Intent i = new Intent(getApplicationContext(), TablesToUpdateActivity.class);
                    Bundle b = new Bundle();
                    b.putString("action", "refund");
                    i.putExtras(b);
                    startActivity(i);
...
//        });
        ...
        itemsale.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (db.getAllitemsaletoUp().size()==0 &&db.getAllitemsaletoUpNew().size()==0)
                {

...
public class StoreSubmenuAdapter extends RecyclerView.Adapter<StoreSubmenuAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.price.setText(mContext.getString(R.string.currency_oman)+price1.get(position));
...
//                    String id = itid.get(getAdapterPosition());
                    String idPos = itid.get(idPosition);

//                    int adapterPosition = getAdapterPosition();
//                    if (adapterPosition != RecyclerView.NO_POSITION) {
//                        idPosition = itid.get(idPosition);
//                        System.out.println("CHILLER:ITID:" + idPosition);
//                    } else {
//                        System.out.println("Invalid adapter position");
//                    }
...
//                        if (idPosition != RecyclerView.NO_POSITION) {
//                            pric = price1.get(idPosition);
//                            // Your code here
//                            System.out.println("CHILLER:ITID:" + pric);
//                        } else {

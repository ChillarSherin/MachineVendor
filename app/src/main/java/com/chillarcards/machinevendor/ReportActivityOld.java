...
// */
//public class ReportActivityOld extends Activity {
//
//    Button Submit;
//    TextView fromdate;
//    Date d1;
...
//                Toast.makeText(ReportActivityOld.this, "Please select Date ", Toast.LENGTH_SHORT).show();
//            } else {
...
//                    Logger.getLogger(ReportActivityOld.class.getName()).log(Level.SEVERE, null, ex);
//                }
//
//
//                //Converting D1
...
//            DatePickerDialog dpd = new DatePickerDialog(ReportActivityOld.this,
...
//            } else {
//
//                Toast.makeText(ReportActivityOld.this, "No Sale Transactions in DB!", Toast.LENGTH_SHORT).show();
//            }
//
//        });
//
...
//                    Toast.makeText(this, "no enble", Toast.LENGTH_SHORT).show();
//
//                    // Bluetooth is not enabled, prompt the user to enable it
//                    Intent enableBtIntent = new Intent(BluetoothAdapter.ACTION_REQUEST_ENABLE);
//                    int REQUEST_ENABLE_BT = 101;
//                    if (ActivityCompat.checkSelfPermission(ReportActivityOld.this, android.Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
...
//
//                    // Bluetooth is enabled, proceed with printer discovery or printing
//                    try {
//                        checkPrinter();
//                        Toast.makeText(this, "checkPrinter", Toast.LENGTH_SHORT).show();
//
//                    } catch (IOException e) {
...
//    }
//
//    private void checkPrinter() throws IOException {
...
//            // Check if the device is a printer based on its characteristics
//            if (isPrinter(device)) {
//                // Perform printing operations
//                // You may need to establish a connection with the printer using BluetoothSocket
//                // and then send print data
//                sendPrintDataToDevice(device);
//                break;
//            }
//        }
//    }
//    private void sendPrintDataToDevice(BluetoothDevice device) throws IOException {
...
//        }
//
//        String DEVICE_UUID = UUID.randomUUID().toString().replace("-", "");
//        BluetoothSocket socket = device.createRfcommSocketToServiceRecord(UUID.fromString(DEVICE_UUID));
//
//        // Connect to the printer
//        socket.connect();
//
//        OutputStream outputStream = socket.getOutputStream();
//        outputStream.write("Hello, Printer!".getBytes());
//        outputStream.close();
//        socket.close();
//
//        //        printView(printFrameView,device);
//    }
//
...
//        // Check if the device name contains "Printer" (case-insensitive check)
//        return deviceName != null && deviceName.toLowerCase().contains("printer");
//
//    }
//    private void printView(View view, BluetoothDevice printerDevice) {
...
//                    //PDF
//                    convertViewToPdf(view, outputStream);
...
//
//                } catch (IOException e) {
//                    Log.e("TAG", "Error writing bitmap to output stream", e);
//                }
//            }
//
//            @Override
//            public void onLayout(PrintAttributes oldAttributes, PrintAttributes newAttributes, CancellationSignal cancellationSignal, LayoutResultCallback callback, Bundle extras) {
//                // Report print attributes
...
//
//        // Print to the selected Bluetooth printer
...
////        printHelper.setPrintDocumentAdapter(new PrintDocumentAdapter() {
////        });
////
////        // Print to the selected Bluetooth printer
////        if (printerDevice != null) {
////            printHelper.print("Print Job", new PrintAttributes.Builder().build(), printerDevice);
////        }
//
//    }
//    private Bitmap createBitmapFromView(View view) {
//        // Measure and layout the view
//        int width = View.MeasureSpec.makeMeasureSpec(view.getWidth(), View.MeasureSpec.EXACTLY);
//        int height = View.MeasureSpec.makeMeasureSpec(view.getHeight(), View.MeasureSpec.EXACTLY);
//
...
//        } catch (IOException e) {
//            Log.e("TAG", "Error writing PDF to output stream", e);
//        }
//
//        pdfDocument.close();
//    }

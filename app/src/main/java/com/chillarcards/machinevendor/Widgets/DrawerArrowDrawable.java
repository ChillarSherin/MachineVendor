...
public class DrawerArrowDrawable extends Drawable {
  ...
  private class BridgingLine {
     ...
     * ends drawn for {@link Paint.Cap#ROUND} style lines.
     */
   ...
   * via {@link androidx.core.widget.DrawerLayout.DrawerListener#onDrawerSlide(android.view.View, float)}'s {@code slideOffset} parameter.
   */

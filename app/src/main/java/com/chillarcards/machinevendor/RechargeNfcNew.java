...
public class RechargeNfcNew  extends Activity {
...
//                                                                char[] rechh=fillerFn(rech_id);
//                                                                char[] tott= fillerFn(String.valueOf(total));
//
//                                                                authFifthSectorWrite = apis.tama_authenticate_mifare(TARGET_NUM,
//                                                                        AUTH_SIXTH_SECT, key6, KEYA);
//
//
//                                                                if (authFifthSectorWrite == 0) {
//
//
//                                                                    wrLastRechMcId = apis.tama_write_target(WRITE_LAST_RECH_MC_ID,
//                                                                            machine, machine.length);
//
//                                                                    wrLastRechId = apis.tama_write_target(WRITE_LAST_RECH_ID,
//                                                                            rechh, rechh.length);
//                                                                    wrlastRechAmt = apis.tama_write_target(WRITE_LAST_RECH_AMT,
//                                                                            tott, tott.length);
//
//                                                                    if(wrLastRechId==0){
//                                                                        Toast.makeText(context, "SUCCESS!", Toast.LENGTH_SHORT).show();
//                                                                        GetRecharge(trans_id,Prev,Current,total,resultCardSerial);
//                                                                    }else{
...
//        });
    ...
    private void GetRecharge(String trans_id, Float prev, Float current, Float total, String resultCardSerial) {

        Recharge_Data recharg = new Recharge_Data(trans_id, userid, transtype_id, prev, current, resultCardSerial,
        ...
        printBill(prev,current,total,resultCardSerial,trans_id);

    }

    private void printBill(Float prev, Float current, Float total, String resultCardSerial, String trans_id) {
        ...
        System.out.println("Total Amount " + current);
        ...
        printbundle.putString("Amount", String.valueOf(current));

...
public class OlineRechargeCheck extends Activity {
...
//
//                                                } else {
//                                                    Toast.makeText(context, "Authentication FAILED00",
//                                                            Toast.LENGTH_SHORT).show();
//
//                                                }
//
...
//        Toast.makeText(getApplicationContext(),"GetAmountFromServer",Toast.LENGTH_SHORT).show();
        ...
        if (onlinetrans.equals("")) {
            ...
            URL = Constants.APP_URL + "r_next_online_recharge.php?machineUserName=" + User_name + "&machineUserPassword=" + Pass_word + "&schoolMachineCode=" + schoomachcode + "&cardSerial=" + cardSerial;

        } else {
            System.out.println("GetAmountfromserverNew" + " Next time ");

            URL = Constants.APP_URL + "r_next_online_recharge.php?machineUserName=" + User_name + "&machineUserPassword=" + Pass_word + "&schoolMachineCode=" + schoomachcode + "&cardSerial=" + cardSerial + "&onlineTransactionID=" + onlinetrans;
...
//        db.deleteAllrecharge();
        ...
        Recharge_Data recharg = new Recharge_Data(trans_id, userid, transtype_id, previousbalnce, (float) currentbalance, cardserialnumber,
                currentDateTimeString, "", trans_id, currentDateTimeString, total, 2, "");

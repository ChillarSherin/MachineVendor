...
/**
 * Created by Codmob on 26-09-17.
 */

public class ReInitializeActivity extends Activity {

    int useridinteger;

    String User_name, Pass_word, userID, schooid, schoomachcode, machineserial, machineID, machineSL, versionName = "";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_reinitialize);

        db = DatabaseHandler.getInstance(getApplicationContext());


        dlg = new Dialog(ReInitializeActivity.this);
    ...
    private void parseJSONBlockedcards(String json) {
        ...
        try {
            ...
            try {
                ...
                System.out.println("CHILLAR finally CAlling intent");
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (server_respose.equals("success")) {
                            ...
                            Toast.makeText(getApplicationContext(), "Successfully Reinitialised!", Toast.LENGTH_SHORT).show();
                            dlg.cancel();
